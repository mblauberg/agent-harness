...
export const MCP_PROJECTION_REGISTRY = Object.freeze({
  ...
  [FABRIC_OPERATIONS.spawnAgent]: none("pending secret-free spawn custody result"),
  [FABRIC_OPERATIONS.attachAgent]: none("pending secret-free attach custody result"),
  ...
  [FABRIC_OPERATIONS.createTeam]: none("pending secret-free atomic team custody result"),

...
import {
  AGENT_TOPOLOGY_PROJECTION_FEATURE, GATE_SYSTEM_SUPERSESSION_FEATURE, WORK_FACTS_PROJECTION_FEATURE,
    ...
    switch (operation) {
      ...
      case FABRIC_OPERATIONS.projectionViewPage: {
        ...
        return this.#operatorProjections.viewPage(
          ...
          context.features.includes(RUN_IDENTITY_PROJECTION_FEATURE) ? "include" : "omit", context.features.includes(AGENT_TOPOLOGY_PROJECTION_FEATURE) ? "include" : "omit", context.features.includes(WORK_FACTS_PROJECTION_FEATURE) ? "include" : "omit",
        );
      }

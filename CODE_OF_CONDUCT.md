...
- Focusing on what is best for the community as a whole, as well as for us as
  individuals
...
private route [`SECURITY.md`](SECURITY.md) uses: GitHub's private
vulnerability-reporting or draft security-advisory flow for this repository. If
private reporting is unavailable, open a content-free issue asking the
maintainers to enable a private channel, and put no details in it.
...
Changes from the upstream text: the reporting contact points at the private
route in `SECURITY.md`, and spelling follows Australian English to match the

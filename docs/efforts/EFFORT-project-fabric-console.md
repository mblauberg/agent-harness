...
[Issue #129](https://github.com/mblauberg/provenant/issues/129) with [PR
#133](https://github.com/mblauberg/provenant/pull/133), and [issue
#134](https://github.com/mblauberg/provenant/issues/134) with [PR
...
- [#131](https://github.com/mblauberg/provenant/issues/131): a terminal-owner
  seam for generation loss;
- [#132](https://github.com/mblauberg/provenant/issues/132): removal of
  redundant repository-local wrapper hash manifests; and
- [#139](https://github.com/mblauberg/provenant/issues/139): a supported fresh
  Agent Fabric launch/bootstrap path.

...
[Issue #22](https://github.com/mblauberg/provenant/issues/22), [ADR
...
specifications own the W010 route. Retired implementation notes remain in Git
history and are not current-status owners.

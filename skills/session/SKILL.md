...
and index it; never delete it. Update `work-map` only when an
effort's durable route changes; live state (owner, dependencies, gates,
progress) belongs to the project's work tracker, never the map.

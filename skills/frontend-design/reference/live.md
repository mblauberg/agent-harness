...
```
LOOP:
  node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-poll.mjs"   # default long timeout; no --timeout=
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-status.mjs"
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-resume.mjs" --id SESSION_ID
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-complete.mjs" --id SESSION_ID
```
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-wrap.mjs" --id EVENT_ID --count EVENT_COUNT --element-id "ELEMENT_ID" --classes "class1,class2" --tag "div" --text "TEXT_SNIPPET"
```
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-poll.mjs" --reply EVENT_ID done --file RELATIVE_PATH
```
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-poll.mjs" --reply EVENT_ID error "Short reason"
```
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/live-server.mjs" stop
```
...
```bash
node "${AGENTS_HOME:-$HOME/.agents}/skills/frontend-design/scripts/detect-csp.mjs"
```
